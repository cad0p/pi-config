...
when plan good rewind to `context-gathered` and start impl subagent and review subagent, push to draft PR as you go and monitor ci, and perform the verification
checklist in repo docs (blocker: stop and ask to create if not found). repeat until good.
